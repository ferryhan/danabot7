...
ka = LineClient(authToken='ExU5xqEfLLebIT7R7dU6.IiJnPeResOKRi4vJwMMpvG.x//5AOOW2x/aoLZpwoF6zrW/nOaDRs/0y5ssxzydCoY=')
kh = LineClient(authToken='ExoOCDwph8nQsEVmZBK1.cK4uT61O3U5d9wFp2Ebteq.ZSvYK3tnKeXEFubv7kteGEbqh24Sz++D4YJil+baMM8=')
...
def sendMention(to, mid, firstmessage):
    try:
        ...
        bot = runtime(eltime)
        text += mention+" ☞Jam : "+datetime.strftime(timeNow,'%H:%M:%S')+" Wib\n☄╠◈ Group : "+str(len(gid))+"\n☄╠◈ Teman : "+str(len(teman))+"\n☄╠◈ Expired : In "+hari+"\n☄╠◈ Version : ╠ |..ͮ̋F́̋̀͊̊.̷̡̛̆̏̽̎̇̌̎ͮ͋ͬ̑̐̆E.̡̢̀ͩ̂ͯ͊́͂̅́ͥͮ̃͑ͥ.ͤ̔͒ͦͮ҉Ř.̵̸́͋ͮ̋̋̔͝.̡̢̑̅ͭͭ̑̈ͯ̉ͤ́ͣ̅ͮ̏ͪ͟.R̸̈ͤ͜͡.̅̇́̌.͑͋̔̽ͬ̃́͋̉̀̅Y̷.̉̎̌ͥ̆ͭ͒ͪ͞.̎ͤ̄̃̌ͭ̅̀͡  | ╣\n☄╠◈ Tanggal : "+datetime.strftime(timeNow,'%Y-%m-%d')+"\n☄╠◈ Runtime : \n  ╠◈ "+bot
...
def help():
    ...
    key = key.title()
    helpMessage = "╔╠ |..ͮ̋F́̋̀͊̊.̷̡̛̆̏̽̎̇̌̎ͮ͋ͬ̑̐̆E.̡̢̀ͩ̂ͯ͊́͂̅́ͥͮ̃͑ͥ.ͤ̔͒ͦͮ҉Ř.̵̸́͋ͮ̋̋̔͝.̡̢̑̅ͭͭ̑̈ͯ̉ͤ́ͣ̅ͮ̏ͪ͟.R̸̈ͤ͜͡.̅̇́̌.͑͋̔̽ͬ̃́͋̉̀̅Y̷.̉̎̌ͥ̆ͭ͒ͪ͞.̎ͤ̄̃̌ͭ̅̀͡  | ╣Self Help Message」\n╠◈ [ Gunakan〄╠◈ " + key + " 」Di depanya ]\n" + \
                  "╠◈ " + key + "Me\n" + \
                  ...
                  "╠◈ " + key + "Listadmin\n" + \
                  "╠◈ " + key + "Listpro\n" + \
                  "\n╚══[ Ketik Refresh ]\n⇱Powered : ╠ |..ͮ̋danaBot.̎ͤ̄̃̌ͭ̅̀͡  | ╣⇲\n⇱Creator : ╠ |..ͮ̋F́̋̀͊̊.̷̡̛̆̏̽̎̇̌̎ͮ͋ͬ̑̐̆E.̡̢̀ͩ̂ͯ͊́͂̅́ͥͮ̃͑ͥ.ͤ̔͒ͦͮ҉Ř.̵̸́͋ͮ̋̋̔͝.̡̢̑̅ͭͭ̑̈ͯ̉ͤ́ͣ̅ͮ̏ͪ͟.R̸̈ͤ͜͡.̅̇́̌.͑͋̔̽ͬ̃́͋̉̀̅Y̷.̉̎̌ͥ̆ͭ͒ͪ͞.̎ͤ̄̃̌ͭ̅̀͡  | ╣⇲"
    return helpMessage
...
def helpbot():
    ...
    helpMessage1 = "\n╠════════ \n╠═[ Blacklist Kicker ] \n╠════════ \n╠═[ Gunakan「 " + key + " 」di depan ]\n" + \
                  ...
                  "\n╚══[ Ketik Refresh ]\n⇱Powered : ╠ |..ͮ̋F́̋̀͊̊.̷̡̛̆̏̽̎̇̌̎ͮ͋ͬ̑̐̆E.̡̢̀ͩ̂ͯ͊́͂̅́ͥͮ̃͑ͥ.ͤ̔͒ͦͮ҉Ř.̵̸́͋ͮ̋̋̔͝.̡̢̑̅ͭͭ̑̈ͯ̉ͤ́ͣ̅ͮ̏ͪ͟.R̸̈ͤ͜͡.̅̇́̌.͑͋̔̽ͬ̃́͋̉̀̅Y̷.̉̎̌ͥ̆ͭ͒ͪ͞.̎ͤ̄̃̌ͭ̅̀͡  | ╣⇲\n⇱Creator : ╠ |..ͮ̋F́̋̀͊̊.̷̡̛̆̏̽̎̇̌̎ͮ͋ͬ̑̐̆E.̡̢̀ͩ̂ͯ͊́͂̅́ͥͮ̃͑ͥ.ͤ̔͒ͦͮ҉Ř.̵̸́͋ͮ̋̋̔͝.̡̢̑̅ͭͭ̑̈ͯ̉ͤ́ͣ̅ͮ̏ͪ͟.R̸̈ͤ͜͡.̅̇́̌.͑͋̔̽ͬ̃́͋̉̀̅Y̷.̉̎̌ͥ̆ͭ͒ͪ͞.̎ͤ̄̃̌ͭ̅̀͡  | ╣⇲"
    return helpMessage1
...
#UPDATE FOTO
               ...
               if msg.contentType == 0:
                    ...
                    if text is None:
                        ...
                        if cmd == "bot on":
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                tz = pytz.timezone("Asia/Jakarta")
                                timeNow = datetime.now(tz=tz)
                                md = "╔[ Settings protection ] \n╠╾[ Squad : DanaBot ] \n╠╾[ Suport : ╠ |..ͮ̋F́̋̀͊̊.̷̡̛̆̏̽̎̇̌̎ͮ͋ͬ̑̐̆E.̡̢̀ͩ̂ͯ͊́͂̅́ͥͮ̃͑ͥ.ͤ̔͒ͦͮ҉Ř.̵̸́͋ͮ̋̋̔͝.̡̢̑̅ͭͭ̑̈ͯ̉ͤ́ͣ̅ͮ̏ͪ͟.R̸̈ͤ͜͡.̅̇́̌.͑͋̔̽ͬ̃́͋̉̀̅Y̷.̉̎̌ͥ̆ͭ͒ͪ͞.̎ͤ̄̃̌ͭ̅̀͡  | ╣ ]\n\n"
                        ...
                        elif cmd == "cekk" or text.lower() == 'absen':
                            if msg._from in admin:
...
#===========BOT UPDATE============#
                        elif cmd == "hallo" or text.lower() == 'assalamualaikum':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
